    ...
    T: Interface,
{
    ...
    pub fn mag_int_xaxis(&mut self, setting: FLAG) -> Result<(), T::Error> {
        ...
        self.interface
            .write(Sensor::Magnetometer, register::Mag::INT_CFG_M.addr(), data)?;
    ...
    pub fn set_mag_threshold(&mut self, threshold: f32) -> Result<(), T::Error> {
        ...
        self.interface.write(
            Sensor::Magnetometer,
            register::Mag::INT_THS_H_M.addr(),
            data_high,
        )?;
        self.interface.write(
            Sensor::Magnetometer,
            register::Mag::INT_THS_L_M.addr(),
            data_low,
        )?;
    ...
    pub fn set_mag_offset(&mut self, offset: (f32, f32, f32)) -> Result<(), T::Error> {
        ...
        self.interface.write(
            Sensor::Magnetometer,
            register::Mag::OFFSET_X_REG_H_M.addr(),
            x_high,
        )?;
        ...
        self.interface.write(
            Sensor::Magnetometer,
            register::Mag::OFFSET_Y_REG_L_M.addr(),
            y_low,
        )?;
        self.interface.write(
            Sensor::Magnetometer,
            register::Mag::OFFSET_Y_REG_H_M.addr(),
            y_high,
        )?;
        ...
        self.interface.write(
            Sensor::Magnetometer,
            register::Mag::OFFSET_Z_REG_L_M.addr(),
            z_low,
        )?;
        self.interface.write(
            Sensor::Magnetometer,
            register::Mag::OFFSET_Z_REG_H_M.addr(),
            z_high,
        )?;
